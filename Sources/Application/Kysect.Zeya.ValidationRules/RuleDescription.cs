...
public static class RuleDescription
{
    public static class Github
    {
        ...
        public static string AutoBranchDeletionEnabled = "GHR0004";
        public static string BuildWorkflowEnabled = "GHR0005";
    }
    ...
    public static class SourceCode
    {
        ...
        public static string ArtifactsOutputEnables = "SRC0003";
        ...
        public static string RequiredPackagesAdded = "SRC0013";
    ...
    public static class Nuget
    {
        ...
        public static string MetadataHaveCorrectValue = "NUP0002";
    }
}